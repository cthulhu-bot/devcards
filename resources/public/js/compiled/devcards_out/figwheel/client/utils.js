...
return (new CustomEvent(event_name,(function (){var obj34082 = {"detail":data};
return obj34082;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__24822__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__24822__auto__)){
var and__24822__auto____$1 = (window["CustomEvent"]);
...
var args34087 = [];
var len__25909__auto___34093 = arguments.length;
var i__25910__auto___34094 = (0);
while(true){
if((i__25910__auto___34094 < len__25909__auto___34093)){
args34087.push((arguments[i__25910__auto___34094]));

var G__34095 = (i__25910__auto___34094 + (1));
i__25910__auto___34094 = G__34095;
continue;
} else {
}
break;
...
var f = (function (){var pred__34090 = cljs.core._EQ_;
var expr__34091 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34090.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34091))){
return ((function (pred__34090,expr__34091){
return (function (p1__34083_SHARP_){
return console.warn(p1__34083_SHARP_);
});
;})(pred__34090,expr__34091))
} else {
if(cljs.core.truth_(pred__34090.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34091))){
return ((function (pred__34090,expr__34091){
return (function (p1__34084_SHARP_){
return console.debug(p1__34084_SHARP_);
});
;})(pred__34090,expr__34091))
} else {
if(cljs.core.truth_(pred__34090.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34091))){
return ((function (pred__34090,expr__34091){
return (function (p1__34085_SHARP_){
return console.error(p1__34085_SHARP_);
});
;})(pred__34090,expr__34091))
} else {
return ((function (pred__34090,expr__34091){
return (function (p1__34086_SHARP_){
return console.log(p1__34086_SHARP_);
});
;})(pred__34090,expr__34091))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34097){
var map__34100 = p__34097;
var map__34100__$1 = ((((!((map__34100 == null)))?((((map__34100.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34100.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34100):map__34100);
var opts = map__34100__$1;
var eval_fn = cljs.core.get.call(null,map__34100__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34102_SHARP_);
});})(new_def))
);
...
return (function (p__34103){
var vec__34104 = p__34103;
var ky = cljs.core.nth.call(null,vec__34104,(0),null);
var v = cljs.core.nth.call(null,vec__34104,(1),null);
...
var args34107 = [];
var len__25909__auto___34110 = arguments.length;
var i__25910__auto___34111 = (0);
while(true){
if((i__25910__auto___34111 < len__25909__auto___34110)){
args34107.push((arguments[i__25910__auto___34111]));

var G__34112 = (i__25910__auto___34111 + (1));
i__25910__auto___34111 = G__34112;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__24822__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1513976122383