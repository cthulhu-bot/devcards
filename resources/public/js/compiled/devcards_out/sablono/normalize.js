...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__27733_SHARP_){
return ((p1__27733_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__27733_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__27735,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__27735;
}
});
...
var len__25909__auto___27738 = arguments.length;
var i__25910__auto___27739 = (0);
while(true){
if((i__25910__auto___27739 < len__25909__auto___27738)){
args__25916__auto__.push((arguments[i__25910__auto___27739]));

var G__27740 = (i__25910__auto___27739 + (1));
i__25910__auto___27739 = G__27740;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25917__auto__);
});
...
var G__27737 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__27737,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__27737;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq27736){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27736));
});
...
var vec__27746 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__27746,(0),null);
var names = cljs.core.nth.call(null,vec__27746,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27746,tag_name,names){
return (function (p1__27741_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__27741_SHARP_));
});})(matches,vec__27746,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__27746,tag_name,names){
return (function (p1__27742_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__27742_SHARP_));
});})(matches,vec__27746,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__27749){
var vec__27756 = p__27749;
var seq__27757 = cljs.core.seq.call(null,vec__27756);
var first__27758 = cljs.core.first.call(null,seq__27757);
var seq__27757__$1 = cljs.core.next.call(null,seq__27757);
var tag = first__27758;
var content = seq__27757__$1;
...
var vec__27759 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__27759,(0),null);
var id = cljs.core.nth.call(null,vec__27759,(1),null);
var class$ = cljs.core.nth.call(null,vec__27759,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1513976118343