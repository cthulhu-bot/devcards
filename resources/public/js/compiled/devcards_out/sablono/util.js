...
var x__25497__auto__ = (((x == null))?null:x);
var m__25498__auto__ = (sablono.util.to_str[goog.typeOf(x__25497__auto__)]);
if(!((m__25498__auto__ == null))){
return m__25498__auto__.call(null,x);
} else {
var m__25498__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__25498__auto____$1 == null))){
return m__25498__auto____$1.call(null,x);
} else {
...
var x__25497__auto__ = (((x == null))?null:x);
var m__25498__auto__ = (sablono.util.to_uri[goog.typeOf(x__25497__auto__)]);
if(!((m__25498__auto__ == null))){
return m__25498__auto__.call(null,x);
} else {
var m__25498__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25498__auto____$1 == null))){
return m__25498__auto____$1.call(null,x);
} else {
...
var len__25909__auto___27719 = arguments.length;
var i__25910__auto___27720 = (0);
while(true){
if((i__25910__auto___27720 < len__25909__auto___27719)){
args__25916__auto__.push((arguments[i__25910__auto___27720]));

var G__27721 = (i__25910__auto___27720 + (1));
i__25910__auto___27720 = G__27721;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25917__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq27718){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq27718));
});
...
var vec__27725 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__27727;
var words = seq__27726__$1;
...
var G__27729 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__27729,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__27729;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__27730_SHARP_){
if(typeof p1__27730_SHARP_ === 'string'){
return p1__27730_SHARP_;
} else {
return cljs.core.seq.call(null,p1__27730_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24834__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1513976118295