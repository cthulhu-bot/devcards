...
var args33246 = [];
var len__25909__auto___33250 = arguments.length;
var i__25910__auto___33251 = (0);
while(true){
if((i__25910__auto___33251 < len__25909__auto___33250)){
args33246.push((arguments[i__25910__auto___33251]));

var G__33252 = (i__25910__auto___33251 + (1));
i__25910__auto___33251 = G__33252;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33246.length)].join('')));
...
var G__33249 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33249,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33249;
}
});
...
var or__24834__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25909__auto___33257 = arguments.length;
var i__25910__auto___33258 = (0);
while(true){
if((i__25910__auto___33258 < len__25909__auto___33257)){
args__25916__auto__.push((arguments[i__25910__auto___33258]));

var G__33259 = (i__25910__auto___33258 + (1));
i__25910__auto___33258 = G__33259;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25917__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33254){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33255,G__33256,seq33254__$2);
});
...
var line = cljs.core.get.call(null,map__33263__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33263__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33263,map__33263__$1,file,line,column){
return (function (p1__33260_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33260_SHARP_));
});})(map__33263,map__33263__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25759__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25759__auto__,prefer_table__25760__auto__,method_cache__25761__auto__,cached_hierarchy__25762__auto__,hierarchy__25763__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24834__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24834__auto__)){
return or__24834__auto__;
} else {
...
var temp__4657__auto___33265 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33265)){
var message_33266 = temp__4657__auto___33265;
cljs.core.println.call(null,message_33266);
} else {
}
...
var temp__4657__auto___33267 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33267)){
var message_33268 = temp__4657__auto___33267;
cljs.core.println.call(null,message_33268);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24822__auto__ = typeof exception.stack === 'string';
if(and__24822__auto__){
var G__33278 = exception.stack;
var G__33278__$1 = (((G__33278 == null))?null:clojure.string.split_lines.call(null,G__33278));
var G__33278__$2 = (((G__33278__$1 == null))?null:cljs.core.get.call(null,G__33278__$1,depth));
if((G__33278__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33278__$2);
}
} else {
...
var vec__33279 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33279,(0),null);
var column = cljs.core.nth.call(null,vec__33279,(1),null);
var vec__33282 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33282,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33282,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33282,(2),null);
...
var m__$1 = (function (){var G__33286 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33286) {
case "fail":
...
var G__33292 = (function (){var G__33291 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33291);
} else {
return G__33291;
}
})();
...
return cljs.core.vary_meta.call(null,G__33294,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33297){var e = e33297;
var G__33298 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33298) {
...
var vec__33303 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33303,(0),null);
var types = vec__33303;
...
return cljs.core.map.call(null,(function (p__33315){
var vec__33316 = p__33315;
var ns = cljs.core.nth.call(null,vec__33316,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33316,(1),null);
return ((function (vec__33316,ns,vars__$1){
return (function (){
...
var G__33319 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33319) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1){
return (function (){
var seq__33320 = cljs.core.seq.call(null,vars__$1);
var chunk__33321 = null;
var count__33322 = (0);
var i__33323 = (0);
while(true){
if((i__33323 < count__33322)){
var v = cljs.core._nth.call(null,chunk__33321,i__33323);
var temp__4657__auto___33325 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33325)){
var t_33326 = temp__4657__auto___33325;
each_fixture_fn.call(null,((function (seq__33320,chunk__33321,count__33322,i__33323,t_33326,temp__4657__auto___33325,v,each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33326)));
});})(seq__33320,chunk__33321,count__33322,i__33323,t_33326,temp__4657__auto___33325,v,each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1))
);
} else {
}

var G__33327 = seq__33320;
var G__33328 = chunk__33321;
var G__33329 = count__33322;
var G__33330 = (i__33323 + (1));
seq__33320 = G__33327;
chunk__33321 = G__33328;
count__33322 = G__33329;
i__33323 = G__33330;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33320);
if(temp__4657__auto__){
var seq__33320__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33320__$1)){
var c__25645__auto__ = cljs.core.chunk_first.call(null,seq__33320__$1);
var G__33331 = cljs.core.chunk_rest.call(null,seq__33320__$1);
var G__33332 = c__25645__auto__;
var G__33333 = cljs.core.count.call(null,c__25645__auto__);
var G__33334 = (0);
seq__33320 = G__33331;
chunk__33321 = G__33332;
count__33322 = G__33333;
i__33323 = G__33334;
continue;
} else {
var v = cljs.core.first.call(null,seq__33320__$1);
var temp__4657__auto___33335__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33335__$1)){
var t_33336 = temp__4657__auto___33335__$1;
each_fixture_fn.call(null,((function (seq__33320,chunk__33321,count__33322,i__33323,t_33336,temp__4657__auto___33335__$1,v,seq__33320__$1,temp__4657__auto__,each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33336)));
});})(seq__33320,chunk__33321,count__33322,i__33323,t_33336,temp__4657__auto___33335__$1,v,seq__33320__$1,temp__4657__auto__,each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1))
);
} else {
}

var G__33337 = cljs.core.next.call(null,seq__33320__$1);
var G__33338 = null;
var G__33339 = (0);
var G__33340 = (0);
seq__33320 = G__33337;
chunk__33321 = G__33338;
count__33322 = G__33339;
i__33323 = G__33340;
continue;
}
} else {
...
});})(each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1))
);
});})(each_fixture_fn,G__33319,env,once_fixtures,each_fixtures,vec__33316,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1513976121327